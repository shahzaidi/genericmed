...
const ShopAllproductsMobile = () => {
  ...
  return (
    ...
    <div className="filtersficed"onClick={handleToggleFilters}>
    ...
    <div className="rating-filter">
     ...
     <div className="shopssallproduct">
              {products.map((product, index) => (
                <div key={product?._id} className="imagesshopto">
                    ...
                    >
                      ...
                      >
                        <button
                          ...
                          onClick={dispatch(addProductInWishlist(product._id))}
                        >
                  ...
                  <div className="in">
                    ...
                    <div className="rating">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <span
                          key={i}
                          className={`stars ${i < isRating ? "selected" : ""}`}
                          // onClick={() => handleStarsClick(i)}
                        >
                          &#9733;
                        </span>
                      ))}
                      <span className="reviews">{`${isRating} `}</span>
                      <span className="helpful">{product?.name}</span>
                    </div>
                    <p className="praao">{`$${product?.price}`}</p>

                    <div className="productwishes-icons">
        ...
        {selectedTab === "price" && (
          <div className="price-filter">
               <div className="price-contain">
                  ...
                  <div className="sliyfhdermob">
                    <div className="sliderr__trackmob" />
                    <div
                      className="slider__rangemob"
                      style={{
                        left: `${(price[0] / MAX) * 100}%`,
                        width: `${((price[1] - price[0]) / MAX) * 100}%`,
                      }}
                ...
                <div id="single-track-multi-range-valuessmob" className="mt-3">
                  Range
                  <span className="d-flex flex-column">
                    <div className={"values"}>
                      ${price[0]}-${price[1]}
...
export default ShopAllproductsMobile;
