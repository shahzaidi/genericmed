          ...
          <div className="proshop">
            ...
            <div className="shopssallproduct">
              {loading ? (
                ...
                <p className="eroo">{error}</p>
              ) : products && products.length <= 0 ? (
                <p className="noitem">No Items Available to show!</p>
              ) : (
                // <p className="eroo">bsvhvshuhsghqjs</p>
